...
% err_linTE(k)=(immse(sim_te,ylin_te'));
% err_linTM(k)=(immse(sim_tm,ylin_tm'));
% 
% err_cubicTE(k)=(immse(sim_te,ycubic_te'));
% err_cubicTM(k)=(immse(sim_tm,ycubic_tm'));
% 
% err_polyTE(k)=(immse(sim_te,ypoly_te'));
% err_polyTM(k)=(immse(sim_tm,ypoly_tm'));
