...
%%
network=load('.\data\NN64NL464v1tansig.mat');
N=51;
...
%network results
for k=1:N
    input=load(['.\data\1350nm\nn\input-lam1350height',num2str(hght(k))]);
    input=input.data';
...
for k=1:length(hght)
    ...
    data=load(['.\data\1350nm\simulation\neff-strip-width400-1400(51))height',num2str(hght(k)),'wavlength1350']);
...
set(gcf,'PaperPosition', myfiguresize);
%%
print(fig1,['.\figure\lam1350NN64TE'],'-dmeta','-r300');
print(fig2,['.\figure\lam1350NN64TM'],'-dmeta','-r300');
print(fig3,['.\figure\lam1350N64SimuTE'],'-dmeta','-r300');
print(fig4,['.\figure\lam1350N64SimuTM'],'-dmeta','-r300');
