...
%network results
for k=1:N
    input=load(['.\data\1650nm\nn\input-lam1650height',num2str(hght(k))]);
    input=input.data';
...
for k=1:length(hght)
    ...
    data=load(['.\data\1650nm\simulation\neff-strip-width400-1400(51))height',num2str(hght(k)),'wavlength1650']);
...
set(gcf,'PaperPosition', myfiguresize);
%%
print(fig1,['.\figure\lam1650NN64TE'],'-dmeta','-r300');
print(fig2,['.\figure\lam1650NN64TM'],'-dmeta','-r300');
print(fig3,['.\figure\lam1650N64SimuTE'],'-dmeta','-r300');
print(fig4,['.\figure\lam1650N64SimuTM'],'-dmeta','-r300');
